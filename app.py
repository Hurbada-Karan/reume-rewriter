...
def generate_automated_audit(cv_text, jd_text, api_key):
    ...
    if not clean_key or clean_key == "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":
...
with st.sidebar:
    ...
    GROQ_API_KEY = user_api_key if user_api_key.strip() else "PASTE_YOUR_GROQ_API_KEY_HERE"
